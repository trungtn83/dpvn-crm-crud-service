...
public class Customers {
  ...
  public static class References {
    ...
    public static final String LAST_SUCCESSFUL_TRANSACTION_DATE = "LAST_SUCCESSFUL_TRANSACTION_DATE";
    public static final String LAST_TRANSACTION_DATE = "LAST_TRANSACTION_DATE";
    public static final String OTHER = "OTHER";
  }

  /**
   * Chia khách hàng thành 1 số phân loại cố định theo business như sau:
   * - SOLD: khách hàng đã từng bán
   * - TAKING_CARE: khách đang chăm sóc, dựa trên lượt interaction/task có trong 1 tuần (có thể cầu hình sau)
   * - cont...
   */
